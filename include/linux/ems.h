...
static inline const struct cpumask *ecs_cpus_allowed(struct task_struct *p) { return cpu_possible_mask; }
static inline const struct cpumask *cpus_binding_mask(struct task_struct *p) { return cpu_possible_mask; }
