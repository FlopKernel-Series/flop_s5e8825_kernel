...
enum s2mf301_irq_source {
	...
	FG_INT,
#endif
#if IS_ENABLED(CONFIG_LEDS_S2MF301_FLASH) || IS_ENABLED(CONFIG_TOP_S2MF301)
	FLED_INT,
#endif
...
#define S2MF301_IRQSRC_CC_RID	(1 << 0)
#define S2MF301_IRQSRC_PM_RID	(1 << 1)
...
enum s2mf301_irq {
	...
	S2MF301_PM_ADC_REQ_DONE4_GPADC1_WAKEUP,
	S2MF301_PM_ADC_REQ_DONE4_GPADC2_WAKEUP,
	S2MF301_PM_ADC_REQ_DONE4_WET_STATUS_GPADC1,
	S2MF301_PM_ADC_REQ_DONE4_WET_STATUS_GPADC2,
	...
	S2MF301_PM_ADC_CHANGE_INT4_PM_RID_ATTACH,
	S2MF301_PM_ADC_CHANGE_INT4_PM_RID_DETACH,
	S2MF301_PM_ADC_CHANGE_INT4_ICHGIN_TH,
#endif
#if IS_ENABLED(CONFIG_REGULATOR_S2MF301)
