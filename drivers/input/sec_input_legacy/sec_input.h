...
#define EXYNOS_DISPLAY_INPUT_NOTIFIER ((IS_ENABLED(CONFIG_EXYNOS_DPU30) || IS_ENABLED(CONFIG_DRM_SAMSUNG_DPU)) && (IS_ENABLED(CONFIG_PANEL_NOTIFY)) || IS_ENABLED(CONFIG_SEC_PANEL_NOTIFIER_V2))
