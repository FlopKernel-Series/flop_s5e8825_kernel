...
extern int usdm_mdnie_set_def_wrgb(struct mdnie_info *mdnie,
		unsigned char r, unsigned char g, unsigned char b);
extern int usdm_mdnie_set_cur_wrgb(struct mdnie_info *mdnie,
		unsigned char r, unsigned char g, unsigned char b);
extern int usdm_mdnie_cur_wrgb_to_byte_array(struct mdnie_info *mdnie,
		unsigned char *dst, unsigned int stride);
extern int usdm_mdnie_get_anti_glare_ratio(struct mdnie_info *mdnie);
extern int panel_mdnie_update(struct panel_device *panel);
extern int usdm_mdnie_update_wrgb(struct mdnie_info *mdnie,
		unsigned char r, unsigned char g, unsigned char b);
...
static inline int usdm_mdnie_set_def_wrgb(struct mdnie_info *mdnie,
		unsigned char r, unsigned char g, unsigned char b) { return 0; }
static inline int usdm_mdnie_set_cur_wrgb(struct mdnie_info *mdnie,
		unsigned char r, unsigned char g, unsigned char b) { return 0; }
static inline int usdm_mdnie_cur_wrgb_to_byte_array(struct mdnie_info *mdnie,
		unsigned char *dst, unsigned int stride) { return 0; }
static inline int usdm_mdnie_update_wrgb(struct mdnie_info *mdnie,
		unsigned char r, unsigned char g, unsigned char b) { return 0; }
