...
int s6e3fc3_a33x_maptbl_getidx_ffc(struct maptbl *tbl)
{
	int idx;
	u32 dsi_clk;
	...
	switch (dsi_clk) {
	case 1108000:
		idx = S6E3FC3_A33X_HS_CLK_1108;
		break;
	case 1124000:
		idx = S6E3FC3_A33X_HS_CLK_1124;
		break;
	case 1125000:
		idx = S6E3FC3_A33X_HS_CLK_1125;
		break;
	default:
...
struct pnobj_func s6e3fc3_a33x_function_table[MAX_S6E3FC3_A33X_FUNCTION] = {
	[S6E3FC3_A33X_MAPTBL_GETIDX_FFC] = __PNOBJ_FUNC_INITIALIZER(S6E3FC3_A33X_MAPTBL_GETIDX_FFC, s6e3fc3_a33x_maptbl_getidx_ffc),
};
...
static int __init s6e3fc3_a33x_panel_init(void)
{
	...
	s6e3fc3_init(&s6e3fc3_a33x_panel_info);
	usdm_panel_function_insert_array(s6e3fc3_a33x_function_table, ARRAY_SIZE(s6e3fc3_a33x_function_table));
	usdm_register_common_panel(&s6e3fc3_a33x_panel_info);

	SEC_DETECT_LOG("Initialized s6e3fc3_a33x panel driver\n");
	return 0;
}

static void __exit s6e3fc3_a33x_panel_exit(void)
{
	usdm_deregister_common_panel(&s6e3fc3_a33x_panel_info);
}
