...
int usdm_init_dimming_info(struct dimming_info *, struct dimming_init_info *);
int usdm_init_dimming_mtp(struct dimming_info *, s32 (*)[MAX_COLOR]);
...
static inline s64 disp_pow_round(s64 num, u32 digits)
{
	...
	return usdm_disp_div64(num + 5 * usdm_disp_pow(10, digits - 1),
			usdm_disp_pow(10, digits)) * usdm_disp_pow(10, digits);
}
int usdm_process_dimming(struct dimming_info *);
...
#else
static inline int usdm_init_dimming_info(struct dimming_info *dim_info, struct dimming_init_info *src) { return 0; }
static inline int usdm_init_dimming_mtp(struct dimming_info *dim_info, s32 (*mtp)[MAX_COLOR]) { return 0; }
...
static inline s64 usdm_disp_interpolation64(s64 from, s64 to, int cur_step, int total_step) { return 0; }
static inline s64 disp_round(s64 num, u32 digits) { return 0; }
static inline s64 usdm_disp_div64(s64 num, s64 den) { return 0; }
#ifdef DIMMING_CALC_PRECISE
static inline s64 disp_div64_round(s64 num, s64 den, u32 digits) { return 0; }
#endif
static inline int usdm_process_dimming(struct dimming_info *dim_info) { return 0; }
