...
int usdm_panel_resource_update_by_name(struct panel_device *panel, char *name);
...
ssize_t usdm_attr_store_for_each(struct class *cls, const char *name, const char *buf, size_t size);
ssize_t usdm_attr_show_for_each(struct class *cls, const char *name, char *buf);
ssize_t usdm_attr_exist_for_each(struct class *cls, const char *name);
#else
...
static inline ssize_t usdm_attr_store_for_each(struct class *cls, const char *name, const char *buf, size_t size) { return 0; }
static inline ssize_t usdm_attr_show_for_each(struct class *cls, const char *name, char *buf) { return 0; }
static inline ssize_t usdm_attr_exist_for_each(struct class *cls, const char *name) { return 0; }
#endif
